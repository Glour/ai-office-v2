...
5. Security hygiene - exposed secrets, public endpoints, weak config changes, risky ports?
6. Failure hygiene - new FAIL without repro steps? fix the report format
7. Memory hygiene - `memory/handoff.md` stale on active work? write fresh one
