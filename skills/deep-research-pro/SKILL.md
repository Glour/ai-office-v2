...
Сохранение:
```
{{WORKSPACE_PATH}}research/[slug]/report.md
```
...
```
sessions_spawn(
  task: "Проведи deep research по теме: [ТЕМА]. Прочитай skills/deep-research-pro/SKILL.md и следуй workflow. Цель: [цель]. Сохрани отчёт в {{WORKSPACE_PATH}}research/[slug]/report.md",
  label: "research-[slug]",
  model: "sonnet"
)
```
...
"Что происходит с рынком недвижимости в {{COUNTRY}}?"
```
