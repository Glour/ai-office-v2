...
|---|---|---|
| **Repo** | `{{CONTRIBUTOR}}/last30days-skill` | `{{CONTRIBUTOR}}/last30days-skill` |
...
```bash
python3 -c "
import sys, json; sys.path.insert(0, './/scripts/lib')
import bird_x
...
- [ ] No hardcoded paths (e.g., `/Users/{{CONTRIBUTOR}}/...`)
...
| Hardcoded paths in codebase | Low | Medium | Grep for `/Users/{{CONTRIBUTOR}}` before release |
| SKILL.md name still says `last30daystest` | Low | High | Already fixed in commit `4e972d0` |

## References

- Private repo: `https://github.com/{{CONTRIBUTOR}}/last30days-skill.git`
- Public repo: `https://github.com/{{CONTRIBUTOR}}/last30days-skill.git`
