...
# Continuous improvement / planning directories
...
echo "  goals/            — monthly + weekly goals"
echo "  strategy/         — strategy sessions"
echo "  kaizen/           — daily notes, insights, improvement loop"
echo "  habits/           — habit tracker"
echo "  obsidian/         — Obsidian vault"
echo "  data/             — admin and financial data"
echo ""
